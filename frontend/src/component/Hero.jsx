...
function Hero({ heroData, heroCount, setHeroCount }) {
  return (
    <div className='w-[100%] h-[100%]  relative' >
      <div className='absolute  text-[#88d9ee]  text-[20px] md:text-[40px] lg:text-[55px] md:left-[10%] md:top-[90px] lg:top-[130px] left-[10%] top-[10px] leading-tight'>
        <p>{heroData.text1}</p>
        <p className='mt-2'>{heroData.text2}</p>
      </div>
